function getAlbum(id, length) {
    ...
    req.onreadystatechange = function () {
        ...
        if (req.readyState === 4 && req.status === 200) {
            ...
            document.getElementById("preview").innerHTML = "<p>Preview</p><img src=\"https://via.placeholder.com/150/000000/FFFFFF?text=photo+ " + album_text[9].id + "\">";
			document.getElementById("preview1").innerHTML = "<p></p><img src=\"https://via.placeholder.com/150/000000/FFFFFF?text=photo+ " + album_text[8].id + "\">";
			document.getElementById("preview2").innerHTML = "<p></p><img src=\"https://via.placeholder.com/150/000000/FFFFFF?text=photo+ " + album_text[7].id + "\">";
			document.getElementById("preview3").innerHTML = "<p></p><img src=\"https://via.placeholder.com/150/000000/FFFFFF?text=photo+ " + album_text[6].id + "\">";
